...
export const ko = {
  ...
  alt: "Seedance 2.0: 멀티모달 입력 완전 가이드",
  related: "**관련 검색**: Seedance 2.0, Seedance 튜토리얼, Seedance 중국어 버전, 멀티모달 AI 영상, @ 참조 프롬프트.",
  closing: "멀티모달 입력을 직접 테스트할 준비가 되셨나요? 아래 버튼으로 **Seedance 2.0**을 여세요 — **Seedance 중국어 버전** UI를 포함한 완전한 멀티모달 워크플로입니다.",
  main: [
