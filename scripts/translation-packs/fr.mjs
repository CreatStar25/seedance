...
export const fr = {
  ...
  related: "**Recherches associées** : Seedance 2.0, tutoriel Seedance, version chinoise Seedance, vidéo IA multimodale, prompts @ référence.",
  closing: "Prêt à tester l'entrée multimodale ? Utilisez le bouton ci-dessous pour ouvrir **Seedance 2.0** — workflow multimodal complet, y compris l'interface **version chinoise Seedance**.",
  main: [
