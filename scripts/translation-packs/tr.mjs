...
export const tr = {
  ...
  alt: "Seedance 2.0: çok modlu girişin tam rehberi",
  related: "**İlgili aramalar**: Seedance 2.0, Seedance eğitimi, Seedance Çince sürüm, çok modlu AI video, @ referans promptları.",
  closing: "Çok modlu girişi kendiniz denemeye hazır mısınız? Aşağıdaki düğmeyle **Seedance 2.0**'ı açın — **Seedance Çince sürüm** arayüzü dahil tam çok modlu iş akışı.",
  main: [
