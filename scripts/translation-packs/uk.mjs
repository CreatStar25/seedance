...
export const uk = {
  ...
  alt: "Seedance 2.0: повний розбір мультимодального вводу",
  related: "**Схожі запити**: Seedance 2.0, урок Seedance, китайська версія Seedance, мультимодальне AI-відео, промпти @ референс.",
  closing: "Готові протестувати мультимодальний ввід? Натисніть кнопку нижче, щоб відкрити **Seedance 2.0** — повний мультимодальний workflow, включно з інтерфейсом **китайської версії Seedance**.",
  main: [
