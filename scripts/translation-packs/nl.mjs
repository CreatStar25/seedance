...
export const nl = {
  ...
  alt: "Seedance 2.0: volledige gids voor multimodale invoer",
  related: "**Gerelateerde zoekopdrachten**: Seedance 2.0, Seedance-tutorial, Seedance Chinese versie, multimodale AI-video, @-referentieprompts.",
  closing: "Klaar om multimodale invoer zelf te testen? Gebruik de knop hieronder om **Seedance 2.0** te openen — volledige multimodale workflow, inclusief **Seedance Chinese versie**-interface.",
  main: [
