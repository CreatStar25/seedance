...
export const pt = {
  ...
  alt: "Seedance 2.0: guia completo de entrada multimodal",
  related: "**Pesquisas relacionadas**: Seedance 2.0, tutorial Seedance, versão chinesa Seedance, vídeo IA multimodal, prompts @ referência.",
  closing: "Pronto para testar a entrada multimodal? Use o botão abaixo para abrir **Seedance 2.0** — fluxo multimodal completo, incluindo a interface **versão chinesa Seedance**.",
  main: [
