...
export const ms = {
  ...
  related: "**Carian berkaitan**: Seedance 2.0, tutorial Seedance, versi Cina Seedance, video AI multimodal, prompt @ rujukan.",
  closing: "Bersedia untuk mencuba input multimodal? Gunakan butang di bawah untuk membuka **Seedance 2.0** — aliran kerja multimodal penuh, termasuk UI **versi Cina Seedance**.",
  main: [
