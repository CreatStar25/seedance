...
export const it = {
  ...
  alt: "Seedance 2.0: guida completa all'input multimodale",
  related: "**Ricerche correlate**: Seedance 2.0, tutorial Seedance, versione cinese Seedance, video IA multimodale, prompt @ riferimento.",
  closing: "Pronto a provare l'input multimodale? Usa il pulsante qui sotto per aprire **Seedance 2.0** — workflow multimodale completo, inclusa l'interfaccia **versione cinese Seedance**.",
  main: [
